...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { car_capacity: @truck.car_capacity, flatbed: @truck.flatbed, flatbed_type: @truck.flatbed_type, make: @truck.make, model: @truck.model, name: @truck.name, year: @truck.year } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { car_capacity: @truck.car_capacity, flatbed: @truck.flatbed, flatbed_type: @truck.flatbed_type, make: @truck.make, model: @truck.model, name: @truck.name, year: @truck.year } }
