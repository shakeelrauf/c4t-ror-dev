...
ActiveRecord::Schema.define(version: 2019_01_08_065716) do
  ...
  create_table "user_configs", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
